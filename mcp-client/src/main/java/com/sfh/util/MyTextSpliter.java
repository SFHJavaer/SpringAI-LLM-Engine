...
public class MyTextSpliter extends TextSplitter {
    ...
    public MyTextSpliter() {
        this(800, 350, 5, 10000, true, Arrays.asList(".", "!", "?", "\n"));
    }
 
    public MyTextSpliter(boolean keepSeparator) {
        this(800, 350, 5, 10000, keepSeparator, Arrays.asList(".", "!", "?", "\n"));
    }
 
    public MyTextSpliter(int chunkSize, int minChunkSizeChars, int minChunkLengthToEmbed, int maxNumChunks, boolean keepSeparator, List<String> splitList) {
